...
export const appRoutes: Route[] = [
    {
        path: '', loadComponent: () => import('./core/layouts/main-layout/main-layout.component').then((c) => c.MainLayoutComponent), children: [
            ...
            { path: 'healthy', loadComponent: () => import('./features/healthy/healthy.component').then((c) => c.HealthyComponent), title: 'Healthy' },
            { path: 'healthy/meal/:id', loadComponent: () => import('./features/healthy/components/meal-details/meal-details.component').then((c) => c.MealDetailsComponent), title: 'Meal Details' },
