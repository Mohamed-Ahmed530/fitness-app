...
export const appRoutes: Route[] = [
    {
        path: '', loadComponent: () => import('./core/layouts/main-layout/main-layout.component').then((c) => c.MainLayoutComponent), children: [
            ...
            { path: 'profile', loadComponent: () => import('./features/user-profile/components/userProfile.component').then((c) => c.UserProfileComponent), canActivate:[authGuard], title: 'Profile' },
        ]
    },
    {
